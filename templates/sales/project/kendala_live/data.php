    ...
    function detail(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.modal-title').text('Update Project Redesain'); // Set title to Bootstrap modal title
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label">Update Progress <span class="text-danger">*</span></label>
                            <div class="col-md-12">
                                <select name="status_update" id="status_update" class="form-control" placeholder="Pilih" data-plugin="select2">
                                    <option value="">--Pilih Progress--</option>
                                    <option value="PROSES GOLIVE">PROSES GOLIVE</option>
                                </select>
...
<script>
    function save() {
        ...
        url = "<?php echo site_url('sales/project/kendala_live_update') ?>";
