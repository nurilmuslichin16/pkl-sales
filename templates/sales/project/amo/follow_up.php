    ...
    <div class="col-md-5">
        <form action="#" id="form" class="form-horizontal">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="control-label">MITRA AMO</label>
                    <div class="col-md-12">
                        <select name="mitra_amo" id="mitra_amo" class="form-control" placeholder="Pilih" data-plugin="select2" disabled>
...
<script>
    $('#status_update').change(function() {
        if( $(this).val() == 22) {
            $('#mitra_amo').attr('disabled',false);
        } else {       
            $('#mitra_amo').attr('disabled',true);
        }
    });
    ...
    {
        var url;
        url = "<?php echo site_url('sales/project/update_amo')?>";
